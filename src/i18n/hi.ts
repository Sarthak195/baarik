...
export const hi: Dictionary = {
  ...
  report: {
    ...
    askHeading: 'इस दस्तावेज़ के बारे में पूछें',
    askLede:
      'उत्तर केवल आपके दिए गए दस्तावेज़ से दिया जाता है। यदि उसमें आपके प्रश्न का उत्तर नहीं है, तो अनुमान लगाने के बजाय आपको यही बताया जाएगा।',
    askLabel: 'आपका प्रश्न',
    askPlaceholder: 'क्या वे मुझे किसी प्रतिस्पर्धी कंपनी में जाने से रोक सकते हैं?',
    askSubmit: 'पूछें',
    askNotFound: 'इस दस्तावेज़ में नहीं मिला',
    askCitedFrom: 'इस अंश से उत्तर दिया गया',
    askCertainty: {
      stated: 'दस्तावेज़ यह सीधे कहता है',
      implied: 'यह दस्तावेज़ में कही गई बात से निकलता है',
      not_addressed: 'दस्तावेज़ इस बात पर कुछ नहीं कहता',
    },
    benchmarkLabel: 'किसके मुक़ाबले',
